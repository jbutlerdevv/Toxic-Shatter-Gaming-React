...
const Home = () => {
    return (
        <div>
            <div className="card bg-transparent text-center w-50 mx-auto mt-5 p-5 main-card">
                <img src="./assets/imgs/tsg-header.png" className="card-img-top" alt="..." />
                    <div className="card-body text-light">
                        <p className="card-text">We are a gaming community full of gamers that love to just game. If you're looking for a great group of friends to squad up with, don't hesitate and join the Discord now... <h4><a href="https://discord.gg/Xk6JqW8" target="_blank" className="nav-link font-weight-bold">Click this link to join</a></h4> </p>
                    </div>
            </div>
